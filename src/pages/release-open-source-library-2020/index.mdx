...
description: 'I am going to tell you how we released in 2019, what the problems are there, and how to solve them.'
date: '2020-01-04T15:25:17.421Z'
---

import Notice from '../../components/notice';
import ActionLink from '../../components/actionLink';

In this article, I'm going to talk about how to release open source library as I build up a little script to ease the process. After that, I will show you the pain points in that process. I will show you a new process which solves the problems. And finally, I will introduce a tool for it.

## Table of Contents

1. How to Release Open Source Library in 2019
2. Problems
3. How to Release Open Source Library in 2020
4. What's different?
5. Introducing Ship.js

<Notice title="Disclaimer" level="trivial" className="mt-8">
  <p>
    I am the author of <a href="https://github.com/algolia/shipjs">Ship.js</a>.
    At the end of this article, I will talk a bit about it. It's okay if you
    don't/can't use Ship.js. This article will still tell you the new process
    and how it will ease your releases.
  </p>
</Notice>
...
1. `master + release`
   ...
   - release is a snapshot of latest release.
   - You might use `develop + master` or whatever.
2. `master` **only**: Almost same with the above except that you don't maintain any snapshot branch for lastest release.

Each strategy has pros and cons and you should choose what fits your needs. You can read a dedicated article [Branching Strategies](/branching-strategies) to learn more.
...
- The new version which is semenatically bumped can be wrong if you wrote a wrong commit message before. However, you don't get a chance to fix it.
- `conventional-changelog` updates the changelog for you. However, you didn't get a chance to refine it.
- You used a wrong version of one of your tools, leading to a different build result.

### You are blocked.

- You have e2e tests which takes 30 minutes, so you had to wait for the script to finish.
...
<Notice title="Tokens" level="tip" className="mt-8">
  <p>
    For CI service to release to NPM and push tags to GitHub, you need to
    configure NPM token and GitHub token as environment variables in your CI
    service.
  </p>
</Notice>
...
Again, now you're not doing it alone any more. The PR can be reviewed by others. Since it's asynchronous, the review can happen slowly. There is no pressure. Everyone can take their time to review the changes in the PR. They can run some manual test based on the PR to make sure if everything is okay. Now the burden is shared.

### You manage more than one project.

This isn't solved yet. Instead of having a script in each repository, it will be better to have it as an external tool which adapts to many different projects with configuration.
...
<div className="flex justify-center mt-8">
  <ActionLink href="https://github.com/algolia/shipjs">
    View Ship.js →
  </ActionLink>
</div>
